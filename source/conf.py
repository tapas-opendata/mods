...
latex_documents = [
    (master_doc, 'mods.tex', 'mods Documentation',
     'texty-opendata'),
]
...
man_pages = [
    (master_doc, 'mods', 'mods Documentation', 1)
]
...
texinfo_documents = [
    (master_doc, 'mods', 'mods Documentation',
      'mods', 'One line description of project.'),
]
